  ...
  return (
    <div>
      ...
      <div className="panel">
        ...
        <p className="hint">
          <b>판정</b>: <span style={{ color: '#1B72E8', fontWeight: 700 }}>사실상 필수</span>=보유율 95%+ → 효과 측정 불가 ·
          <span style={{ color: '#1B72E8', fontWeight: 700 }}> 측정가능</span>=보정차이 신뢰(크면 중요, 작거나 음수면 없어도 잘 나감) ·
