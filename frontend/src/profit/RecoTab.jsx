            ...
            <tbody>
              {d.office.length === 0 ? (
                ...
                <tr key={i}>
                  ...
                  <td style={{ fontWeight: 800, color: '#1B72E8' }}>{n(r.score)}</td>
                  <td className="l">
            ...
            {d.office.length === 0 ? (
              ...
              <div className="mcard" key={i}>
                <div className="mc-main">
                  ...
                  <div className="mc-area">기회점수 <b style={{ color: '#1B72E8' }}>{n(r.score)}</b>
          ...
          {(!rows || rows.length === 0) ? (
            ...
            <div className="mcard" key={r.name}>
              <div className="mc-main">
                ...
                <div className="mc-area">경쟁 {fmtComp(r.comp)} · 매칭 {n(r.n)} · 기회점수 <b style={{ color: '#1B72E8' }}>{n(r.score)}</b></div>
              </div>
              <div className="mc-nums">
                <div className="mc-net pos">{n(r.expNet)}<small>만</small></div>
                <div className="mc-occ">예약 {n(r.occ)}%</div>
