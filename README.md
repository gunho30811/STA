# rendit — 네이버부동산 × 삼삼엠투 단기임대 수익성 분석

수도권/전국 오피스텔 월세 매물을 네이버부동산에서 수집하고, 삼삼엠투(단기임대) 데이터와
같은 건물·평수로 매칭해 **임대인 관점의 수익성**을 분석·검색하는 서비스.

> **프로덕션: <https://rendits.duckdns.org>** (Oracle Cloud 춘천 VM + Docker/Caddy — DEPLOY.md 참조)
> 백업: <https://sta-gray.vercel.app> (main push 자동배포 유지, DB는 스냅샷 시점)
